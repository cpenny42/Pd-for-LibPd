...
It will unpack .wav files for each note & velocity in a separate folder.  The [autosampler~] object must be in the same folder as the folder with the unpacked .wav files.

I recommend you use the /soundfonts folder in this pd-for-libpd.  By adding that folder to Pd's search path, all the soundfonts in it will be available to you in Pure Data.
